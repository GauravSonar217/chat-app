    ...
    <section className="pageContainer">
      <div className="card-body flex justify-center items-center gap-4">
        <div className="w-full flex flex-col md:flex-row items-start justify-center gap-5 ">
          <button
            type="button"
            className="p-2 text-lg font-semibold rounded cursor-pointer px-5 bg-gradient-to-b from-[#562B96] to-[#2E105B]"
            onClick={() => navigate("/dashboard")}
          >
            Back
          </button>
          <div className="profileCard rounded-lg w-full h-full md:max-w-[60%]">
            <form
              action="submit"
              className="w-full h-full"
              onSubmit={handleSubmit(onSubmit)}
            >
              <div className="formContainer w-full h-full">
                <div className="bg-[#0C0C1E] bg-gradient-to-b from-[#2E105B] to-[#9D4EDB] w-full h-full p-[1.5px] rounded-xl">
                  <div className="bg-black rounded-xl p-10 h-full flex flex-col justify-center items-center">
                    <h2 className="text-center mb-6">My Profile</h2>
                    <div className="profileCont relative w-35 h-35 md:w-40 md:h-40 border-3 border-white p-1 rounded-full mb-5">
                      <img
                        src={preview}
                        alt=""
